...
Las tablas, figuras y ecuaciones deberán estar numeradas, cada una dentro de su propia categoría.
...
La numeración debe mantenerse en el orden en el que estos elementos aparecen en el documento.

#### Leyendas

Todas las tablas y figuras deberán poseer una leyenda que permita comprender qué información contienen.

En general:

* la leyenda de una **tabla** se coloca **por encima** de la tabla;
* la leyenda de una **figura** se coloca **por debajo** de la figura.

Una buena leyenda debe permitir comprender el contenido general de la tabla o figura sin necesidad de buscar demasiada información adicional en el texto.

Ejemplo:

> **Tabla 1.** Volúmenes de NaOH utilizados para la titulación de tres alícuotas de la muestra problema y concentraciones calculadas a partir de cada determinación.
...
El tamaño de fuente utilizado en tablas, gráficos, figuras y ecuaciones debe ser legible una vez que el elemento haya sido insertado en el documento final.

Puede utilizarse una fuente ligeramente menor que la del cuerpo principal del texto, por ejemplo uno o dos tamaños menos, pero nunca tan pequeña que dificulte la lectura.

También deberá prestarse atención a:

* el tamaño de los ejes;
* las etiquetas;
* las unidades;
* los símbolos;
* las leyendas internas;
* el contraste entre los distintos elementos.

#### Organización gráfica

Debe prestarse atención a la distribución de los elementos gráficos para facilitar la lectura y la comprensión de la información presentada.

Este aspecto puede parecer secundario, pero una buena figura puede hacer que un conjunto complejo de resultados sea mucho más fácil de interpretar.

La correcta confección de figuras requiere práctica.
...
> La concentración obtenida experimentalmente fue ligeramente superior al valor esperado. Esta diferencia podría deberse, entre otros factores, al CO2 disuelto en la muestra problema. El CO2 se solubiliza en soluciones acuosas formando acido carbonico,  lo que conlleva un gasto extra de titulante.
...
* absorción de humedad o CO₂ por determinadas sustancias;
...
* que los resultados estén descriptos antes de ser discutidos;
